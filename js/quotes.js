...
const quoteAndAuthor = document.querySelector("#quotes");
...
quoteAndAuthor.addEventListener("mouseover", () => author.classList.remove("hidden"));
quoteAndAuthor.addEventListener("mouseout", () => author.classList.add("hidden"));
